...
export const routes: Routes = [
  ...
  {
    path: 'asesor/crear-plan',
    loadComponent: () => import('./pages/asesor/crear-plan/crear-plan.page').then(m => m.CrearPlanPage),
    canActivate: [asesorGuard]
  },
  {
    path: 'asesor/crear-plan/:id',
    loadComponent: () => import('./pages/asesor/crear-plan/crear-plan.page').then(m => m.CrearPlanPage),
    canActivate: [asesorGuard]
  },
  {
    path: 'asesor/contrataciones',
    loadComponent: () => import('./pages/asesor/contrataciones/contrataciones.page').then(m => m.ContratacionesPage),
    canActivate: [asesorGuard]
  },
  {
    path: 'asesor/chats',
    loadComponent: () => import('./pages/asesor/chats/chats.page').then(m => m.ChatsPage),
    canActivate: [asesorGuard]
  }
];